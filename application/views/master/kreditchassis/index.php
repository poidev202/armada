	...
	<div id="dataTable">
		<div class="card">
	        <div class="card-body">
	        	<h4 class="card-title">Table Master Cicilan / Kredit Chassis</h4>
                ...
                <ul class="nav nav-tabs customtab" role="tablist">
                    ...
                    <li class="nav-item"> 
                    	<a class="nav-link" data-toggle="tab" href="" role="tab">
                    		<button type='button' class='btn btn-outline-info btn-sm' id='btnTambah'><i class='fa fa-plus'></i> Tambah</button>
                		</a> 
                	</li>
                    <li class="nav-item"> 
                    	<a class="nav-link" data-toggle="tab" href="" role="tab">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tblProses" role="tabpanel">
                        <div class="table-responsive">
			                <table id="tblMasterKreditChassis" class="table table-bordered table-striped table-hover table-sm" style="width: 100%">
	...
	<!-- modal detail -->
	<?php echo modalDetailOpen(false,"lg","primary","Rekap Pembayaran Kredit Chassis"); ?>

        <div class="row">
            <div class="col-md-3 col-xs-6 b-r"> <strong>Nama Armada :</strong>
                <br>
                <span class="text-muted" id="namaArmadaRekap"></span>
            </div>
            <div class="col-md-3 col-xs-6 b-r"> <strong>No Plat / BK :</strong>
                <br>
                <span class="text-muted" id="noBkRekap"></span>
            </div>
            <div class="col-md-3 col-xs-6 b-r"> <strong>Merk Chassis:</strong>
                <br>
                <span class="text-muted" id="merkChassisRekap"></span>
            </div>
            <div class="col-md-3 col-xs-6 b-r"> <strong>Vendor :</strong>
                <br>
                <span class="text-muted" id="vendorRekap"></span>
            </div>
        </div>
        <hr style="margin-bottom: -10px; margin-top: 0px;">

		<div class="table-responsive">
            <table id="tblRekapKreditChassis" class="table table-bordered table-striped table-hover table-sm" style="width: 100%">
                <thead class="thead-info">
                    <tr>
                        <th>No</th>
                        <th>Tanggal Bayar</th>
	        	...
	        	<?php echo form_open("",array("id" => "formData","class" => "m-t-20")); ?>
		            ...
		            <div class="row">
		            	<div class="col-md-6">
				            ...
				            <div class="row">
				            	...
				            	<div class="col-md-6">
						            ...
						            <div class="form-group m-b-5 m-t-10">
						                <label for="merk">Merk Chassis:</label><br>
						                <input type="text" class="form-control" readonly id="merk">
						            </div>
						            <div class="form-group m-b-5 m-t-10">
						                <label for="tipe">Tipe Chassis:</label><br>
		            	...
		            	<div class="col-md-6">
				            ...
				            <div class="form-group m-b-5 m-t-10">
				                <label for="vendor_chassis">Vendor :</label>
...
<?php assets_script_master("kredit_chassis.js"); ?>   